    ...
    <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
            <li class="am-hide-sm-only">
                <a href="javascript:;">
                    <img src="../images/default-head.jpg" alt="" style="float: right" class="am-circle am-fr"
                         width="15%">
                </a>
            </li>
    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">员工信息修改</strong> / <small>Employee
                    Information Modify</small></div>
            </div>
            <hr/>
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-6 am-u-md-pull-6">
                    <div class="am-form am-form-horizontal">
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-11">
                                <input type="date" name="date" id="user-weibo" placeholder="入职日期">
                                <small>入职日期</small>
                            </div>
                        </div>
                        <div class="am-form-group">
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-11">
                                <textarea class="" rows="5" id="user-intro" name="text" style="resize: none"
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-11 am-u-sm-push-3">
                                <button type="submit" id="modify" class="am-btn am-btn-primary" style="color: #000">修改
                                </button>
                                <script>
                                    ...
                                    $('#modify').click(function () {
                                        ...
                                        for (var i = 0; i < objArray; i++) {
                                            if (box[i].checked == true) {
                                                apiContentStr1 += box[i].value + ",";
                                            }
                                        }

                                        apiContentStr1 = apiContentStr1.substring(0, apiContentStr1.length - 1);
                                        console.log(apiContentStr1)
                                        ...
                                        console.log(apiContentStr)
                                        console.log(document.cookie.substring(3, 5))
                                        var id = document.cookie;
                                        console.log(id)
                                        if ($('#user-name').val() == '' && $('#age').val() == '' && apiContentStr1 == '' && $('#user-weibo').val() == '' && apiContentStr == ''  && $('#user-intro').val() == ''){
                                            return alert('请至少修改一项')

                                        }
                                            $.get('/java_thesis_project/empModifyServlet', {
                                                id: id.split(';')[0].substring(3, 4),
                                                name: $('#user-name').val(),
                                                age: $('#age').val(),
                                                hobby: apiContentStr1,
                                                sex: apiContentStr,
                                                date: $('#user-weibo').val(),
                                                select: $('#select').val(),
                                                text: $('#user-intro').val()
