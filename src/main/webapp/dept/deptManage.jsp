...
<header class="am-topbar am-topbar-inverse admin-header">
    ...
    <span id="box"
          style="width: 320px;position: absolute;left: 550px;color: #000;font-size: 18px;font-weight: bold;line-height:50px"></span>
        ...
        <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
            ...
            <li class="am-dropdown" data-am-dropdown>
                <a class="am-dropdown-toggle" data-am-dropdown-toggle href="javascript:;">
                    <span class="am-icon-users"></span> 管理员:<strong
                        style="color: #000;font-weight: 700;">${sessionScope.loginName}</strong><span
    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">部门管理</strong> / <small>Department
                    Manage</small></div>
            </div>
                ...
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <button data-am-modal="{target:'#deptAddDlg'}" type="button" class="am-btn am-btn-default">
                                <span class="am-icon-plus"></span>添加部门
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="am-u-sm-12">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tr id="t1">
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button onclick="openModDlg()" deptId="${sessionScope.deptList[0].id}"
                                                class="redact am-btn am-btn-default am-btn-xs am-text-secondary">
                                            <span class="am-icon-pencil-square-o"></span> 编辑
                                        </button>
                                        <button  deptId="${sessionScope.deptList[0].id}"
                        ...
                        <tr id="t2">
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button onclick="openModDlg()" deptId="${sessionScope.deptList[1].id}"
                                                class="redact am-btn am-btn-default am-btn-xs am-text-secondary">
                                            <span class="am-icon-pencil-square-o"></span> 编辑
                                        </button>
                                        <button  deptId="${sessionScope.deptList[1].id}"
                                                class="del am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span> 删除
                                        </button>
                                    </div>
                        ...
                        <tr id="t3">
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button onclick="openModDlg()" deptId="${sessionScope.deptList[2].id}"
                                                class=" redact am-btn am-btn-default am-btn-xs am-text-secondary">
                                            <span class="am-icon-pencil-square-o"></span> 编辑
                                        </button>
                                        <button  deptId="${sessionScope.deptList[2].id}"
                                                class="del am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span> 删除
                                        </button>
                                    </div>
                        ...
                        <tr id="t4">
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button onclick="openModDlg()" deptId="${sessionScope.deptList[3].id}"
                                                class="redact am-btn am-btn-default am-btn-xs am-text-secondary">
                                            <span class="am-icon-pencil-square-o"></span> 编辑
                                        </button>
                                        <button  deptId="${sessionScope.deptList[3].id}"
                                                class="del am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span> 删除
                                        </button>
                                    </div>
                        ...
                        <tr id="t5">
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button onclick="openModDlg()" deptId="${sessionScope.deptList[4].id}"
                                                class="redact am-btn am-btn-default am-btn-xs am-text-secondary">
                                            <span class="am-icon-pencil-square-o"></span> 编辑
                                        </button>
                                        <button  deptId="${sessionScope.deptList[4].id}"
                                                class="del am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                            <span class="am-icon-trash-o"></span> 删除
                                        </button>
                                    </div>
                    ...
                    <div class="am-cf">
                        <div class="am-fr">
                                        ...
                                        for (let i = 0; i < list.length; i++) {
                                            list[i].onclick = function () {
                                                ...
                                                $.get('/java_thesis_project/page', {
                                                    startIndex: this.getAttribute('pagenum'),
                                                    pageSize: 5
                                                }, function () {
                                                    location.reload();
                                                })
                            ...
                            <p>当前页:<span
                                    style="color: skyblue;font-size: 20px;font-weight: 700">${sessionScope.page.pageNum}</span>,共有<span
                                    style="color: skyblue;font-size: 20px;font-weight: 700">${sessionScope.page.total}</span>条数据，共有<span
                                    style="color: skyblue;font-size: 20px;font-weight: 700">${sessionScope.page.pages}</span>页
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="am-modal-bd  up-frame-body">
            ...
            <div class="am-form">
                <div class="login-form-div">
                    <input type="text" name="deptName" autocomplete="off" id="deptName" value="" placeholder="请输入部门名称">
                </div>
                <div class="login-form-div">
                    <input type="text"  autocomplete="off" name="deptAddr" id="deptAddr" value="" placeholder="请输入部门地址">
                </div>
                <div class="am-cf login-form-div">
                    <input type="button" name="" style="background: #0e90d2;" value="添加"
                           class="sub am-btn am-btn-primary am-btn-lg  am-btn-block am-fl">
                </div>
            <script>
                //部门添加
                $('.sub').click(function () {
                    $.get('/java_thesis_project/addDept?deptName='+$('#deptName').val()+"&deptAddr="+$('#deptAddr').val(),function (response) {
                        alert(response+'添加的部门是：'+$('#deptName').val())
                        location.reload()
...
<div class="am-modal am-modal-no-btn up-frame-bj " tabindex="-1" id="deptModDlg">
    <div class="am-modal-dialog up-frame-parent up-frame-radius">
        ...
        <div class="am-modal-bd  up-frame-body">
            ...
            <div class="am-form">
                <div class="login-form-div">
                    <input type="text" name="deptName" autocomplete="off" id="username" value=""
                           placeholder="请输入部门名称">
                </div>
                <div class="login-form-div">
                    <input type="text" name="deptAttr" autocomplete="off" id="password" value=""
                           placeholder="请输入部门地址">
                </div>
                <div class="am-cf login-form-div">
                    <input type="button" name="" id="update" style="color: #000" value="修改"
                           class="am-btn am-btn-primary am-btn-lg  am-btn-block am-fl">
                </div>
            </div>
            ...
            <script>
                ...
                for (let i = 0; i < dels.length; i++) {
                    dels[i].addEventListener('click',function () {
                        ...
                        if (b){
                            $.get('/java_thesis_project/deleteId?id='+id,{startIndex:pageNum,pageSize:5},function (response) {
                                alert(response)
                                location.reload()
                            })
                ...
                for (let i = 0; i < bts.length; i++) {
                    bts[i].addEventListener('click', function () {
                        ...
                        var data = td.previousSibling.previousSibling.textContent;
                        var data2 = td.previousSibling.previousSibling.previousSibling.previousSibling.textContent;
